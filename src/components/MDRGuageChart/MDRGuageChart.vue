<template>
        <div style="width:180px;height:180px;" class="parent">
            <strong class="guageTitles">{{times[title]}}<br/>(Inner {{validCats[cats[0][cats[0].length -1]]}}%/{{validCats[cats[1][cats[1].length -1]]}}%/{{validCats[cats[2][cats[2].length -1]]}}%)</strong>
            <highcharts 
            ref="guage"
            class="chart" 
